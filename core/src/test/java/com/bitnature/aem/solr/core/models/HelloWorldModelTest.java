 ...
 */
package com.bitnature.aem.solr.core.models;
...
import com.bitnature.aem.solr.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-solr/components/helloworld");
